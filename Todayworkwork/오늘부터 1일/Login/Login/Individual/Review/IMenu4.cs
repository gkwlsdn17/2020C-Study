    ...
    public partial class IMenu4 : UserControl
    {
        ...
        public void ShowListDB()
        {
            try
            {
                ...
                cmd.Connection = conn;
                // insert into review (rev_Num,w_NUM,rev_id,rev_comName, rev_place, rev_field, rev_subject, content,r_date,rev_STAR_PT,rev_COUNT) values(4,1,'testID','testCom','테스트대구','테스트목공','테스트제목','테스트내요요요요오오오오옹',datetime.now,4,2);
